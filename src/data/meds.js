...
const INPATIENT_B_MEDS = [
  ...
  { name: 'SP.NITROLINGUAL 0.4mg/dose (תרסיס ללשון)', sku: '', group: 'לב, לחץ דם וכולסטרול (Cardiovascular & Cholesterol) · נוזלים, זריקות וטיפות' },
  { name: 'T.METFORMIN 850mg GLUCOPHAGE', sku: '', group: 'סוכרת (Diabetes / Antidiabetics) · כדורים בלבד' },
...
const INPATIENT_D_MEDS = [
  ...
  { name: 'SP.NITROLINGUAL 0.4mg/dose (תרסיס ללשון)', sku: '', group: 'לב, לחץ דם וכולסטרול (Cardiovascular & Cholesterol) · נוזלים, זריקות ותרסיסים' },
  { name: 'T.METFORMIN 850mg GLUCOPHAGE', sku: '', group: 'סוכרת (Diabetes / Antidiabetics) · כדורים בלבד' },
  { name: 'GEL GLUCOGEL 15g GLUCOSE', sku: '', group: 'סוכרת (Diabetes / Antidiabetics) · אינסולין וג׳ל' },
  { name: 'I.INSULIN ASPART NOVORAPID 100 units/ml 10ml', sku: '', group: 'סוכרת (Diabetes / Antidiabetics) · אינסולין וג׳ל' },
...
// ===== צנתורים (תת-יחידה בצינתורים) – רשימת תרופות לבקרה לפי קטגוריות (ללא מק״ט) =====
const CATH_MEDS = [
  ...
  { name: 'T.ATORVASTATIN 40mg LIPITOR', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · כדורים וקפסולות' },
  { name: 'T.CAPTOPRIL 12.5mg', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · כדורים וקפסולות' },
  { name: 'T.CLOPIDOGREL 75mg PLAVIX (מדלל דם)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · כדורים וקפסולות' },
  { name: 'T.PRASUGREL 10mg EFFIENT (מדלל דם)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · כדורים וקפסולות' },
  { name: 'T.TICAGRELOR 90mg BRILINTA (מדלל דם)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · כדורים וקפסולות' },
  { name: 'I.ADENOSINE 6 mg ADENOCOR', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.ADRENALINE 1 mg/ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.AMIODARONE 150mg /3ml PROCOR', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.ATROPINE 1 mg/ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.BIVALIRUDIN 250mg ANGIOMAX (מדלל דם)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.DOPAMINE 200mg/5ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.EPHEDRINE 50mg/ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.ESMOLOL 100mg/10ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.FUROSEMIDE 20mg/ 2ml FUSID (משתן)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.HEPARIN 5000 units/ml 5ml (מדלל דם)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.HEPARIN 2units/ml IN SALINE 0.5L (תמיסת שטיפה עם הפרין)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.ISOKET 10mg/10ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.ISOPROTERENOL 0.2 mg/ml ISUPREL', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.LABETALOL 100mg/20ml TRANDATE', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.METOPROLOL 5mg/5ml LOPRESSOR', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.NITROPRUSSIDE 60mg NIPRUSS', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.NORADRENALINE 4mg LEVOPHED', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.PHENYLEPHRINE 500mcg/10ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.PROTAMINE SULPHATE 50 mg/5ml (נוגד הפרין)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.VERAPAMIL 5mg/2ml IKACOR', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'SOL.THROMBIN 5ml RECOTHROM (גורם קרישה מקומי)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'SP.NITROLINGUAL 0.4mg /dose (תרסיס ללשון)', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'SYR.HEPARIN LOCK 100 units/ml 5ml', sku: '', group: 'לב, לחץ דם, כולסטרול וחירום לבבי (Cardiovascular & Catheterization Suite) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.BUPIVACAINE 0.5% 20ml MARCAINE', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.DIPYRONE 1g/2ml OPTALGIN', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.LIDOCAINE 1% 100 mg/10ml', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.LIDOCAINE 2% 200 mg/10ml', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.MIDAZOLAM 5mg/5ml DORMICUM', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.PROPOFOL 1% 20ml', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.PROPOFOL 2% 50ml', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.ROCURONIUM 50mg/5ml ESMERON (מרפה שרירים)', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'SP.LIDOCAINE 10% 80g XYLOCAINE (תרסיס אלחוש)', sku: '', group: 'שיכוך כאב, הרדמה, אלחוש מקומי והרגעה (Analgesics, Anesthetics & Sedation) · נוזלים, זריקות ותרסיסים' },
  { name: 'I.IOHEXOL 350 OMNIPAQUE 100ml', sku: '', group: 'חומרי ניגוד לצינתור ודימות (Contrast Media & Imaging)' },
  { name: 'I.IOHEXOL 350 OMNIPAQUE 500ml', sku: '', group: 'חומרי ניגוד לצינתור ודימות (Contrast Media & Imaging)' },
  { name: 'I.LIPIODOL ULTRA-FLUIDE 10ML', sku: '', group: 'חומרי ניגוד לצינתור ודימות (Contrast Media & Imaging)' },
  ...
  { name: 'I.METHYLPREDNISOLONE DEPO-MEDROL 40mg', sku: '', group: 'סטרואידים (Steroids) · זריקות בלבד' },
  { name: 'INSTILLAGel LIDOCAINE & CHLORHEXIDINE 11ml (ג׳ל אלחוש וחיטוי)', sku: '', group: 'חומרי חיטוי חיצוני (Antiseptics)' },
  { name: 'S.ALCOXIDINE ALCOSEPT 1L', sku: '', group: 'חומרי חיטוי חיצוני (Antiseptics)' },
  { name: 'S.CHLORAPREP 3ml 2%CHG & 70%IPA', sku: '', group: 'חומרי חיטוי חיצוני (Antiseptics)' },
  { name: 'S.CHLORHEXIDINE GLUC. 4% SEPTAL SCRUB', sku: '', group: 'חומרי חיטוי חיצוני (Antiseptics)' },
  { name: 'S.HYDROGEN PEROXIDE 3% 50ml', sku: '', group: 'חומרי חיטוי חיצוני (Antiseptics)' },
  { name: 'S.POVIDONE 10% 1L', sku: '', group: 'חומרי חיטוי חיצוני (Antiseptics)' },
  { name: 'S.SEPTOL SEPTADINE 0.5L', sku: '', group: 'חומרי חיטוי חיצוני (Antiseptics)' },
  { name: 'I.FLUMAZENIL 0.5mg/5ml ANEXATE (נוגד דורמיקום/בנזודיאזפינים)', sku: '', group: 'נוזלי עירוי, מים סטריליים ונוגדים (IV Fluids, Sterile Water & Antidotes)' },
  { name: 'I.GLUCOSE / DEXTROSE 50% 10g/20ml', sku: '', group: 'נוזלי עירוי, מים סטריליים ונוגדים (IV Fluids, Sterile Water & Antidotes)' },
  { name: 'I.SODIUM CHLORIDE 0.9% 10ml', sku: '', group: 'נוזלי עירוי, מים סטריליים ונוגדים (IV Fluids, Sterile Water & Antidotes)' },
  { name: 'I.SODIUM CHLORIDE 0.9% 100ml', sku: '', group: 'נוזלי עירוי, מים סטריליים ונוגדים (IV Fluids, Sterile Water & Antidotes)' },
  { name: 'I.SODIUM CHLORIDE 0.9% 0.5L', sku: '', group: 'נוזלי עירוי, מים סטריליים ונוגדים (IV Fluids, Sterile Water & Antidotes)' },
  { name: 'I.WATER for INJECTION 10ml', sku: '', group: 'נוזלי עירוי, מים סטריליים ונוגדים (IV Fluids, Sterile Water & Antidotes)' },
  { name: 'T.SODIUM CHLORIDE 0.9% 0.5L', sku: '', group: 'נוזלי עירוי, מים סטריליים ונוגדים (IV Fluids, Sterile Water & Antidotes)' },
  { name: 'I.ATOSSISCLEROL 3% 2ml SCLEROVEIN (לטיפול בוורידים/טרשת)', sku: '', group: 'שונות (Miscellaneous)' },
  { name: 'I.ETHANOL ABSOLUTE STERILE 30ml (אלכוהול אבסולוטי סטרילי להזרקה)', sku: '', group: 'שונות (Miscellaneous)' },
  { name: 'I.NEOSTIGMINE 2.5mg/ml (להיפוך שיתוק שרירים / מערכת העצבים)', sku: '', group: 'שונות (Miscellaneous)' },
