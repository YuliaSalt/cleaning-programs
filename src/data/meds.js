...
const ICU_MEDS = [
  { name: 'CALCIUM GLUCONATE 10% 10ml', sku: '32000010', group: 'אלקטרוליטים (Electrolytes)' },
  { name: 'MAGNESIUM SULFATE 50% 10ml', sku: '32000055', group: 'אלקטרוליטים (Electrolytes)' },
  { name: 'POTASSIUM CHLORIDE 15% 10ml', sku: '32000015', group: 'אלקטרוליטים (Electrolytes)' },
  { name: 'POTASSIUM CHLORIDE 600mg (SLOW-K)', sku: '32000071', group: 'אלקטרוליטים (Electrolytes)' },
  { name: 'SODIUM BICARBONATE 8.4% 10ml', sku: '32000017', group: 'אלקטרוליטים (Electrolytes)' },
  ...
  { name: 'AMIODARONE 200mg (PROCOR)', sku: '32000016', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'AMLODIPINE 5mg (NORVASC)', sku: '32000022', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'ATENOLOL 50mg (NORMITEN)', sku: '32000035', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'ATORVASTATIN 10mg (LIPITOR)', sku: '32000010', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'BISOPROLOL 2.5mg (CONCOR)', sku: '32000024', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'CAPTOPRIL 12.5mg', sku: '32000018', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'CARVEDILOL 12.5mg', sku: '32000015', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'ENALAPRIL 10mg (ENALADEX)', sku: '32000022', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'FUROSEMIDE 20mg (FUSID)', sku: '32000001', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'FUROSEMIDE 250mg/25ml', sku: '32000021', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'HYDRALAZINE 20mg', sku: '32000022', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'HYDROCHLOROTHIAZIDE 12.5ml', sku: '31100022', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'ISOSORBIDE DINITRATE 5mg (ISORDIL)', sku: '32000033', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'LABETALOL 100mg/20ml (TRANDATE)', sku: '32000035', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'LOSARTAN 50mg (OCSAAR)', sku: '32000022', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'METOLAZONE 5mg (ZAROXOLYN)', sku: '32000014', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'PROPRANOLOL 10mg (DERALIN)', sku: '32000012', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'RAMIPRIL 2.5mg (TRITACE)', sku: '32000073', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'VALSARTAN 80mg (DIOVAN)', sku: '32000027', group: 'מערכת הלב וכלי הדם (Cardiovascular)' },
  { name: 'COLACHICINE 0.5mg', sku: '32000022', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'DIAZEPAM 5mg (ASSIVAL)', sku: '32000005', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'HALOPERIDOL 5mg/ml', sku: '32000020', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'IBUPROFEN 400mg (ADEX)', sku: '31500011', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'KETAMINE 500mg/10ml', sku: '32000013', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'LIDOCAINE 2% SPRAY', sku: '31400034', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'LIDOCAINE HCl 2% JELLY 30g', sku: '33200004', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'LORAZEPAM 1mg (LORIVAN)', sku: '32000032', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'MIDAZOLAM 5mg/5ml (DORMICUM)', sku: '32000013', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'PARACETAMOL 500mg (ACAMOL)', sku: '32000013', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'PHENYTOIN 250mg/5ml', sku: '32000055', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'PROPOFOL 1% 20ml', sku: '32000015', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'QUETIAPINE 25mg (SEROQUEL)', sku: '32000003', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'SODIUM VALPROATE 300mg', sku: '32000029', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'TRAMADOL 50mg (TRAMAL)', sku: '32000034', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'TRAMADOL 37.5mg + PARACETAMOL (ZALDIAR)', sku: '32000004', group: 'מערכת העצבים, שיכוך כאב והרדמה (Analgesics & CNS)' },
  { name: 'AMINOPHYLLINE 250mg/10ml', sku: '32000017', group: 'מערכת הנשימה ואלרגיות (Respiratory & Allergy)' },
  { name: 'BUDESONIDE (BUDICORT)', sku: '32500011', group: 'מערכת הנשימה ואלרגיות (Respiratory & Allergy)' },
  { name: 'CHLORPHENIRAMINE 10mg', sku: '32000045', group: 'מערכת הנשימה ואלרגיות (Respiratory & Allergy)' },
  { name: 'IPRATROPIUM BROMIDE (ATROVENT)', sku: '32500010', group: 'מערכת הנשימה ואלרגיות (Respiratory & Allergy)' },
  { name: 'SALBUTAMOL (VENTOLIN)', sku: '32500011', group: 'מערכת הנשימה ואלרגיות (Respiratory & Allergy)' },
  { name: 'DEXAMETHASONE 4mg/ml', sku: '32000005', group: 'הורמונים וסוכרת (Endocrine & Diabetes)' },
  { name: 'GLUCAGON 1mg', sku: '32000003', group: 'הורמונים וסוכרת (Endocrine & Diabetes)' },
  { name: 'INSULIN ASPART (NOVORAPID)', sku: '32000001', group: 'הורמונים וסוכרת (Endocrine & Diabetes)' },
  { name: 'INSULIN HUMAN (HUMULIN R)', sku: '32000015', group: 'הורמונים וסוכרת (Endocrine & Diabetes)' },
  { name: 'LEVOTHYROXINE 200mcg', sku: '32000012', group: 'הורמונים וסוכרת (Endocrine & Diabetes)' },
  { name: 'METHYLPREDNISOLONE 125mg', sku: '32000002', group: 'הורמונים וסוכרת (Endocrine & Diabetes)' },
  { name: 'PREDNISONE 20mg', sku: '32000001', group: 'הורמונים וסוכרת (Endocrine & Diabetes)' },
  { name: 'METOCLOPRAMIDE 10mg/2ml (PRAMIN)', sku: '32000007', group: 'מערכת העיכול (Gastrointestinal)' },
  { name: 'OMEPRAZOLE 40mg (CONTROLOC)', sku: '32000010', group: 'מערכת העיכול (Gastrointestinal)' },
]
